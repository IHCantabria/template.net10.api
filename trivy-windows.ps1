...
#usage:
#   .\trivy-windows.ps1 -TrivyVersion "0.70.0" -ScanTarget "." -ReportsFolder "trivy-reports" -SkipVulnerabilityCheck
#
# Parameters:
#   -TrivyVersion           : Trivy version to download (default: "0.70.0")
