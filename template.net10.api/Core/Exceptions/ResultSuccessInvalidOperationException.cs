...
/// <summary>
///     Represents an invalid operation error thrown when attempting to access an exception from a successful
...
public sealed class ResultSuccessInvalidOperationException : CoreException
{
    ...
    /// <summary>
    ///     Initializes a new instance of the <see cref="ResultSuccessInvalidOperationException" /> class with a specified
    ///     error message.
    /// </summary>
