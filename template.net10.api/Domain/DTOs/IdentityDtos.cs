...
{
    /// <summary>
    ///     Initializes a new instance of the <see cref="IdentityDto" /> record with all identity values set to
    ///     <see langword="null" />.
    /// </summary>
    [SetsRequiredMembers]
    ...
    /// <param name="userInternalIdentifier">The unique internal identifier of the authenticated user.</param>
    [SetsRequiredMembers]
    internal IdentityDto(Guid? userUuid, string? userRoleName, string? userIdentifier, short? userInternalIdentifier)
    {
        UserUuid = userUuid;
        UserRoleName = userRoleName;
        UserIdentifier = userIdentifier;
        UserInternalIdentifier = userInternalIdentifier;
    }
    ...
    /// <summary>
    ///     Gets the internal identifier of the authenticated user from the token.
    /// </summary>
    public required short? UserInternalIdentifier { get; init; }
    ...
    /// </summary>
    /// <returns>
    ///     <see langword="true" /> if <see cref="UserIdentifier" /> is not <see langword="null" />; otherwise,
    ///     <see langword="false" />.
    /// </returns>
    ...
    /// <summary>
    ///     Determines whether the identity has a non-null user internal identifier.
    /// </summary>
    /// <returns>
    ///     <see langword="true" /> if <see cref="UserInternalIdentifier" /> is not <see langword="null" />; otherwise,
    ///     <see langword="false" />.
    /// </returns>
    private bool HasUserInternalIdentifier()
    {
        return UserInternalIdentifier is not null;
    }
    ...
    /// </summary>
    /// <returns>
    ///     <see langword="true" /> if the user identifier matches the Genie identifier constant; otherwise,
    ///     <see langword="false" />.
    /// </returns>
    internal bool IsGenie()
    {
        return HasUserIdentifier() && !HasUserInternalIdentifier() &&
               UserIdentifier == GenieIdentityConstants.Identifier;
    }
    ...
    /// </summary>
    /// <returns>
    ///     <see langword="true" /> if <see cref="UserRoleName" /> is not <see langword="null" />; otherwise,
    ///     <see langword="false" />.
    /// </returns>
