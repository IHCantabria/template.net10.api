...
/// <summary>
///     MediatR post-processor that sends a SignalR notification to all clients after a user is successfully created.
/// </summary>
...

{
    ...
    /// <summary>
    ///     Processes the response of a <see cref="CommandCreateUser" /> request and sends a notification if the operation
    ///     succeeded.
    /// </summary>
    /// <param name="request">The create user command that was executed.</param>
    /// <param name="response">The result containing the created <see cref="User" /> or a fault.</param>
    ...
    /// </summary>
    /// <param name="data">The newly created <see cref="User" /> entity.</param>
