...
using template.net10.api.Persistence.Repositories.Extensions;
using template.net10.api.Persistence.Repositories.Interfaces;

namespace template.net10.api.Persistence.Repositories;
    ...
    where TDbContext : DbContext where TEntity : class, IEntity
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var queryable = PrepareProcedureQueryable(procedureCall.ProcedureName, [..procedureCall.Parameters]);
