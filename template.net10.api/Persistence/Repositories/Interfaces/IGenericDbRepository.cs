...
/// <summary>
///     Defines write-context (tracked) operations for a generic EF Core repository scoped to a
    ...
    where TDbContext : DbContext where TEntity : class, IEntity
{
    ...
    /// <returns>
    ///     A <see cref="Try{A}" /> wrapping <see langword="true" /> if any entity matches; otherwise
    ///     <see langword="false" />.
    /// </returns>
    ...
    /// <returns>
    ///     A <see cref="LanguageExt.Common.Result{A}" /> wrapping <see langword="true" /> if any entity matches;
    ...
    /// <param name="cancellationToken">Token to cancel the operation.</param>
    /// <returns>
    ///     A <see cref="LanguageExt.Common.Result{A}" /> wrapping <see langword="true" /> when exactly one entity
    ...
    /// <summary>
    ///     Asynchronously retrieves entities satisfying the specification and projects them server-side to
    ...
    /// <summary>
    ///     Asynchronously retrieves the single entity matching the specification and projects it to
    ///     <typeparamref name="TDto" />.
    /// </summary>
    /// <typeparam name="TDto">The target DTO type.</typeparam>
    /// <param name="specification">The query specification.</param>
    ...
    /// <summary>
    ///     Asynchronously retrieves the first entity matching the specification and projects it to
    ///     <typeparamref name="TDto" />.
    /// </summary>
    /// <typeparam name="TDto">The target DTO type.</typeparam>
    /// <param name="specification">The query specification.</param>
    ...
    /// <param name="cancellationToken">Token to cancel the operation.</param>
    /// <returns>
    ///     A <see cref="LanguageExt.Common.Result{A}" /> wrapping <see langword="true" /> when the procedure executes
    ///     successfully.
    /// </returns>
    ...
    /// <summary>
    ///     Asynchronously executes a stored procedure, applies an optional specification, and projects results to
    ///     <typeparamref name="TDto" />.
    /// </summary>
    /// <typeparam name="TDto">The target DTO type.</typeparam>
    /// <param name="procedureCall">The stored procedure descriptor and its parameters.</param>
    ...
    where TDbContext : DbContext where TEntity : class, IEntity
{
    ...
    /// <summary>
    ///     Asynchronously verifies that exactly one entity satisfies the given verification predicate using a short-lived
    ///     context.
    /// </summary>
    /// <param name="verification">The verification to apply, or <see langword="null" /> to check all entities.</param>
    /// <param name="cancellationToken">Token to cancel the operation.</param>
    ...
    /// <summary>
    ///     Asynchronously retrieves entities satisfying the specification and projects them server-side to
    ///     <typeparamref name="TDto" /> using a short-lived context.
    /// </summary>
    /// <typeparam name="TDto">The target DTO type.</typeparam>
    /// <param name="specification">The query specification, or <see langword="null" /> to retrieve all entities.</param>
    /// <param name="projection">The EF Core server-side projection to apply.</param>
