...
- [ ] `Variables de entorno, sustituir los sigientes placeholders en los ficheros appsettings: HOST_API_URL, HOST_API_DOMAIN, OPEN_TELEMETRY_ENDPOINT_LOG_URL, APP_DB_CONNECTION, HOST_API_CORS_ALLOWED_ORIGINS, HOST_API_SECURITY_JWT_AUDIENCE, HOST_API_SECURITY_JWT_ISSUER, HOST_API_SECURITY_JWT_SECRET y HOST_API_SECURITY_PASSWORD_PEPPER`
